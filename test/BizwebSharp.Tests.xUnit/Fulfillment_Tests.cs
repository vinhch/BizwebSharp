...
namespace BizwebSharp.Tests.xUnit
{
    ...
    public class Fulfillment_Tests : IClassFixture<Fulfillment_Tests_Fixture>
    {
        ...
        [Fact(DisplayName = "Count Fulfillments")]
        ...
        [Fact(DisplayName = "Count Fulfillments With A Filter")]
        public async Task Counts_Fulfillments_With_A_Filter()
        {
            long orderId = Fixture.Created.First().OrderId.Value;
            var fromDate = DateTime.UtcNow.AddDays(-2);
            var count = await Fixture.Service.CountAsync(orderId, new ListOption
            {
        ...
        [Fact(DisplayName = "List Fulfillments")]
        ...
        [Fact(DisplayName = "List Fulfillments With A Filter")]
        public async Task Lists_Fulfillments_With_A_Filter()
        {
            long orderId = Fixture.Created.First().OrderId.Value;
            var fromDate = DateTime.UtcNow.AddDays(-2);
            var list = await Fixture.Service.ListAsync(orderId, new ListOption
            {
                CreatedAtMin = fromDate
            });
        ...
        [Fact(DisplayName = "Get Fulfillments")]
        ...
        [Fact(DisplayName = "Create Fulfillments")]
        ...
        [Fact(DisplayName = "Create Fulfillments With Tracking Numbers")]
        ...
        [Fact(DisplayName = "Create Partial Fulfillments")]
        ...
        [Fact(DisplayName = "Update Fulfillments")]
        ...
        [Fact(DisplayName = "Cancel Fulfillments",
            Skip = "Can't complete or cancel a fulfillment whose status is not 'pending'. It's not clear how to create a fulfillment that's pending.")]
        ...
        [Fact(DisplayName = "Complete Fulfillments",
            Skip = "Can't complete or cancel a fulfillment whose status is not 'pending'. It's not clear how to create a fulfillment that's pending.")]
    ...
    {
        public FulfillmentService Service => new FulfillmentService(Utils.AuthState);
