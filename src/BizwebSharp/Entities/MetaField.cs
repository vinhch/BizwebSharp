...
namespace BizwebSharp
{
    public class MetaField : BaseEntityWithTimeline
    {
        ...
        /// <summary>
        ///     Container for a set of metadata. Namespaces help distinguish between metadata you created and metadata created by
        ///     another individual with a similar namespace (maximum of 20 characters).
        /// </summary>
